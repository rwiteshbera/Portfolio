    ...
    <div className="border-2 rounded-xl border-[#808080] p-5 w-96 bg-black">
      ...
      <div className="flex flex-wrap gap-x-2">
        <Link href={blog?.url  ?? `https://dev.to/rwiteshbera}`} target="_blank">
          <h4 className="border-2 border-[#808080] py-1 px-2 rounded-md m-1 cursor-pointer hover:bg-white hover:border-white hover:text-black">
            Dev.to
          </h4>
        </Link>
        <Link href={blog?.canonical_url  ?? 'https://blog.rwiteshbera.com'} target="_blank">
          <h4 className="border-2 border-[#808080] py-1 px-2 rounded-md m-1 cursor-pointer hover:border-white hover:bg-white hover:text-black">
            Hashnode
          </h4>
        </Link>
      </div>
